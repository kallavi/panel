...
@section('breadcrumbs')
    <x-admin.breadcrumb-item :parent="''">
        <x-slot:item>
            ...
            <x-admin.breadcrumb-item :icon="'true'" />
            <x-admin.breadcrumb-item :title="'Sayfa Ekle'" :class="'text-gray-600 fw-bold lh-1'" />
...
@section('app')
    ...
    <x-admin.wrapper-container>
        <x-slot:content>
            ...
            <x-admin.form id="'kt_ecommerce_add_product_form'" :action="route('pages.store')" :method="'POST'" :class="'create_form'"
                :dataKt="[
                                                ...
                                                <x-admin.card :class="'card-flush border-0 bg-gray-300 bg-opacity-20 pt-12'" :cardHeaderClass="'min-h-25px'" :cardBodyClass="'d-flex flex-stack col'">
                                                    ...
                                                    <x-slot:cardBody>
                                                        <x-admin.tags-wrapper :class="'col-6'">
                                                            <x-slot:tagsWrapper>
                                                                <x-admin.form-input :inputParentClass="'input-group-lg mb-6 fv-row w-100'" :labelTag="'label'"
                                                                    :labelText="'Video Linki'" :labelClass="'form-label required'"
                                                                    :placeholder="'Youtube Linki Giriniz'" :class="'form-control'"
                                                                    :name="'video'" />
                                                        ...
                                                        <x-admin.image-input :changeAvatar="''" :name="'cover'"
                                                            ...
                                                            :textMuted="'Sadece *.png, *.jpg veya *.jpeg uzantılı görsel yükleyebilirsiniz'" />
                                                    </x-slot:cardBody>
                                                </x-admin.card>
                                        ...
                                        <div
                                            ...
                                            <x-slot:cardBody>
                                                <x-admin.image-input :changeAvatar="''" :size="'w-150px h-150px'" :parentClass="'my-3 text-center'" :class="'mb-3'"
                                                    :textMuted="'Sadece *.png, *.jpg veya *.jpeg uzantılı görsel yükleyebilirsiniz'" :name="'image'" />
                                            </x-slot:cardBody>
                                        </x-admin.card>  --}}
                                            {{--  <x-admin.card :class="'border-0 card-flush bg-gray-300 bg-opacity-20 py-4'" :cardBodyClass="'pt-0'">
                                            <x-slot:cardHeader>
                                    ...
                                    <div class="d-flex flex-column flex-xl-row">
                                        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10 ">
                                            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                                ...
                                                <x-admin.card :class="'card-flush border-0 bg-gray-300 bg-opacity-20 pt-12'" :cardHeaderClass="'min-h-25px'">
                                                    <x-slot:cardHeader>
                                                        <div class="card-title text-end m-0">
                                                            <h2>İçerik</h2>
                                                        </div>
                                                    </x-slot:cardHeader>
                                                    <x-slot:cardBody>
                                                        <x-admin.form-textarea :labelTag="'label'" :labelText="'İçerik'" :class="'text-end'"
                                                            :labelClass="'form-label'" :placeholder="'İçerik'" :rows="'9'"
                                            ...
                                            <x-admin.card :class="'card-flush py-4 bg-gray-300 bg-opacity-20 border-0'">
                                                ...
                                                <x-slot:cardBody>
                                                    ...
                                                    <x-admin.form-textarea :inputParentClass="'mb-6'" :labelTag="'label'" :class="'text-end'"
                                                        :labelText="'Sayfa Açıklaması'" :labelClass="'form-label'" :placeholder="'Açıklama Girin'"
                                                        :rows="'4'" :name="'seo_description:ar'" />
                                                </x-slot:cardBody>
                                            </x-admin.card>
                                        </div>
                                    </div>
